  ...
  return (
    <div className="tv">
      ...
      <header className="tv-top">
        <div className="tv-live" style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          <span className="tv-live-dot" />
          LIVE · SKY CAMERA
          <select
            style={{ padding: "4px", borderRadius: "4px", background: "rgba(0,0,0,0.5)", color: "var(--hud)", border: "1px solid var(--hud-dim)", outline: "none", cursor: "pointer", fontFamily: "var(--mono)", fontSize: "12px", opacity: apBusy ? 0.5 : 1 }}
        ...
        <div className="tv-clock">
          ...
          {mse.ok ? "" : "MJPEG · "}{config.airport.name} · {clock}
        </div>
      </header>

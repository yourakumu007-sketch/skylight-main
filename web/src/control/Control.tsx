    ...
    <div className="control">
      ...
      <main>
        <Section title="Location">
          ...
          <Row label="Top 10 Indian Airports" hint="Select to jump and change default">
            <select
              style={{ width: "100%", padding: "6px 8px", borderRadius: "6px", background: "#202532", color: "#aeb6c6", border: "none", outline: "none", cursor: "pointer", fontFamily: "var(--font-mono)", fontSize: "14px" }}
              onChange={(e) => selectTopAirport(e.target.value)}
              value={cfg.airport.icao}
            >
